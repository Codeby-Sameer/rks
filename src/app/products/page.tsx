...
export const metadata: Metadata = {
  ...
  description: "Explore proprietary technology platforms by RK's Brainstorm: Q-Tran training mobile platform & BMS Business Management System.",
};
    ...
    <div className="space-y-20 pb-20 overflow-hidden">
      ...
      <section className="bg-gradient-to-br from-[#1B4F8C] via-[#163f70] to-[#2CA8A4] text-white py-20 text-center space-y-4">
        ...
        <p className="text-lg text-blue-100 max-w-2xl mx-auto">
          Empowering corporate training, workforce quality transformation, and operational management through cutting-edge digital platforms.
        </p>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="card-left bg-white rounded-3xl p-8 sm:p-10 border border-gray-100 shadow-xl space-y-6 flex flex-col justify-between hover:shadow-2xl transition-all">
            <div className="space-y-4">
              ...
              <span className="text-xs font-bold uppercase tracking-wider text-[#E8752C]">Training & Transformation App</span>
              <h2 className="text-3xl font-black text-[#2D2D2D]">Q-Tran</h2>
              <p className="text-sm text-[#6B7280] leading-relaxed">
                Q-Tran is RK&apos;s Brainstorm flagship mobile & web training platform designed for continuous employee skill development, leadership progress tracking, interactive quizzes, and BU-aligned workforce grooming.
              </p>
              <div className="space-y-2 pt-2">
                <div className="flex items-center space-x-2 text-xs font-semibold text-[#2D2D2D]">
                  ...
                  <span>Interactive Corporate Skill Modules</span>
                </div>
                <div className="flex items-center space-x-2 text-xs font-semibold text-[#2D2D2D]">
                  <CheckCircle2 className="w-4 h-4 text-[#2CA8A4]" />
            ...
            <div className="pt-6 border-t border-gray-100 flex items-center justify-between">
              <Link
                ...
                className="bg-gradient-to-r from-[#F2A93B] to-[#E8752C] text-white font-bold px-6 py-3 rounded-full shadow-md hover:shadow-lg transition-all inline-flex items-center gap-2"
              >
